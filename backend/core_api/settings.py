...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-znl#fw+8%4g9l8m$3wf%dfa5&uc8m6(4z3!&2zgdps!!+_4=qb')
...
# MailHog config (set EMAIL_HOST=localhost in .env to use MailHog)
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@mbabali.com')
